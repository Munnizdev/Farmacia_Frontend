    ...
    <div>
      {item.submenu ? (
        <>
          <button
            ...
            className={`w-full flex items-center gap-3 p-2 rounded transition-all duration-300
              ...
              ${isActive ? "bg-[#1d4ed8] text-white" : "text-gray-600 hover:text-white hover:bg-[#1d4ed8]"}
            `}
          >
            {item.icon}
        ...
        <Link
          to={item.href}
          className={`w-full flex items-center gap-3 p-2 rounded transition-all duration-300
            ${isActive ? "bg-[#1d4ed8] text-white" : "text-gray-600 hover:text-white hover:bg-[#1e3a8a]"}
            ${fullyCollapsed ? "justify-center" : "justify-start"}
          `}
        >
          {item.icon}
